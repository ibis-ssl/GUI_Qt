...
public:
    ...
    void setupUi(QMainWindow *Qt_Robot_info)
    {
        ...
        show_speedy->setGeometry(QRect(620, 210, 71, 31));
        ...
        show_connection->setGeometry(QRect(430, 50, 71, 31));
        ...
        show_error0->setGeometry(QRect(330, 10, 41, 31));
        ...
        show_error4->setGeometry(QRect(530, 10, 41, 31));
        show_error6 = new QTextBrowser(centralwidget);
        show_error6->setObjectName("show_error6");
        show_error6->setGeometry(QRect(630, 10, 41, 31));
    ...
    void retranslateUi(QMainWindow *Qt_Robot_info)
    {
        ...
        label_38->setText(QCoreApplication::translate("Qt_Robot_info", "Error", nullptr));
